...
final class TodayViewModel {
    let appCollection: [AppModel] = [
        AppModel(iconImage: UIImage(named: "4.jpg")!, appName: "배타러갈래?", category: "일상", cost: false, appDescription: "돈 많이 벌게 해줄게"),
        ...
        AppModel(iconImage: UIImage(named: "4.jpg")!, appName: "FILTER - Sunset Of Seoul", category: "사진", cost: false, appDescription: "서울의 노을을 담아보세요")
    ]
    
    
    lazy var cards: [TodayCardModel] = [
        TodayCardModel(viewType: CardViewType.appOfTheDay(backgroundImage: UIImage(named: "1.jpg")!, app: AppModel(iconImage: UIImage(named: "4.jpg")!, appName: "배타러갈래?", category: "일상", cost: false, appDescription: "돈 많이 벌게 해줄게"))),
